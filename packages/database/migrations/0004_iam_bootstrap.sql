...
'Bootstrap-only membership verification. SECURITY DEFINER uses a fixed search_path and accepts identity plus selected tenant explicitly. Effective permissions are resolved from tenant role mappings.';
