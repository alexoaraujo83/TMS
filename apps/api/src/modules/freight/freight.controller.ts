...
export class FreightController {
  constructor(private readonly service: FreightService, private readonly matching: MatchingService) {}
  ...
  @Get(':id/matches')
  @RequirePermission('freight:read')
  matches(@CurrentUser() context: RequestContext, @Param('id', new ParseUUIDPipe()) id: string) {
