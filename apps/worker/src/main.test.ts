...
import { normalizeDatabaseUrl } from "./main.js";

test("normalizeDatabaseUrl enforces verify-full without exposing credentials", () => {
  const input = "postgresql://tms_app:secret@example.test:5432/tms?sslmode=require&channel_binding=require";
